...
public class SwiftRdFirebaseAuthPlugin: NSObject, FlutterPlugin {
    
  var currentNonce: String = ""
    
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "rd_firebase_auth", binaryMessenger: registrar.messenger())
    let instance = SwiftRdFirebaseAuthPlugin()
    registrar.addMethodCallDelegate(instance, channel: channel)
  }

  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    if call.method.elementsEqual("snap_chat_login"){
